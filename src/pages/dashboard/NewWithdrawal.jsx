...
const NewWithdrawal = () => {
  ...
  const url = `https://coinstarpro-bitminers-new-backnd.vercel.app/api/requestwithdrawcode/${id}`
  const urlll = `https://coinstarpro-bitminers-new-backnd.vercel.app/api/withdraw/${id}`
  const urlprofit = `https://coinstarpro-bitminers-new-backnd.vercel.app/api/transferprofittoaccount/${id}`
  const urlemail = `https://coinstarpro-bitminers-new-backnd.vercel.app/api/withdrawalemailsend/${id}`
